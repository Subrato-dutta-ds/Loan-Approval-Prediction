...
st.markdown("""
<style>
    /* --- HIDE STREAMLIT HEADER (Fixes the cut-off) --- */
    ...
    /* --- FIXED READABILITY: Force White Text for ALL Labels & Inputs --- */
    ...
    /* Input fields - Darker background with bright text */
    ...
    /* --- METRIC BOXES (CRYSTAL CLEAR NUMBERS) --- */
...
# --- DASHBOARD (PORTFOLIO SCREENSHOT) ---
st.divider()
